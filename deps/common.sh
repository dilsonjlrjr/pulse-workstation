...
if ! sudo sudo apt install apt-transport-https curl ca-certificates software-properties-common libkf5globalaccel-bin yakuake htop wireguard libcurl4-gnutls-dev -y >> ${COMMON_LOG_FILE}
then
